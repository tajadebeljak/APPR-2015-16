...
```{r graF3, echo=FALSE}
ggplot(data=tab%>%filter(Izdatki=='Izdatki za prevoz'), aes(x=Vrsta_potovanja, y=`Meritve`, fill=Destinacija)) + geom_bar(stat = "identity", position = "dodge")
```
...
Zemljevid prikazuje turistično najbolj obiskane države v letu 2014.
