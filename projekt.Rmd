...
Spodnji graf prikazuje kako se število prenočitev na posameznih potovanjih spreminja s starostjo. 
...
Iz spodnjih grafov je razvidno, da se višina izdatkov, ki jih ljudje namenijo za potovanja z leti povečuje, število prenočitev pa zmanjšuje. To velja tako za Slovenijo, kot tudi za tujino. 

```{r graF3, echo=FALSE, fig.cap='Napoved1}
graf_potovanj2 
```

```{r graF3, echo=FALSE, fig.cap='Napoved2'}
graf_prenočitve1 
```
